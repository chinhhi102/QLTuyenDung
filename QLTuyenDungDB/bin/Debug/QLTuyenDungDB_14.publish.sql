...
GO
PRINT N'The following operation was generated from a refactoring log file aa3f3bec-c0a3-43ef-883a-d19df74c4a7f';

PRINT N'Rename [dbo].[tbl_ChuyenMon].[TenChuyenMonID] to TenChuyenMon';


GO
EXECUTE sp_rename @objname = N'[dbo].[tbl_ChuyenMon].[TenChuyenMonID]', @newname = N'TenChuyenMon', @objtype = N'COLUMN';


GO
-- Refactoring step to update target server with deployed transaction logs
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'aa3f3bec-c0a3-43ef-883a-d19df74c4a7f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('aa3f3bec-c0a3-43ef-883a-d19df74c4a7f')
