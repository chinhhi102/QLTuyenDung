...
GO
PRINT N'The following operation was generated from a refactoring log file bf0e8ea3-1ba4-4122-bde7-564f2685d5ed';

PRINT N'Rename [dbo].[tbl_TinhHinhThuViec].[NgayChapNhan] to NgayCapNhap';


GO
EXECUTE sp_rename @objname = N'[dbo].[tbl_TinhHinhThuViec].[NgayChapNhan]', @newname = N'NgayCapNhap', @objtype = N'COLUMN';


GO
PRINT N'Starting rebuilding table [dbo].[tbl_TinhHinhThuViec]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_tbl_TinhHinhThuViec] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[tbl_TinhHinhThuViec])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_tbl_TinhHinhThuViec] ON;
        INSERT INTO [dbo].[tmp_ms_xx_tbl_TinhHinhThuViec] ([TinhHinhThuViecID], [KhaNangLamViec], [ThaiDoLamViec], [KinhNghiemLamViec], [HieuQuaLamViec], [NgayCapNhap])
        SELECT   [TinhHinhThuViecID],
                 [KhaNangLamViec],
                 [ThaiDoLamViec],
                 [KinhNghiemLamViec],
                 [HieuQuaLamViec],
                 [NgayCapNhap]
        FROM     [dbo].[tbl_TinhHinhThuViec]
        ORDER BY [TinhHinhThuViecID] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_tbl_TinhHinhThuViec] OFF;
    END

DROP TABLE [dbo].[tbl_TinhHinhThuViec];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_tbl_TinhHinhThuViec]', N'tbl_TinhHinhThuViec';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'bf0e8ea3-1ba4-4122-bde7-564f2685d5ed')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('bf0e8ea3-1ba4-4122-bde7-564f2685d5ed')
