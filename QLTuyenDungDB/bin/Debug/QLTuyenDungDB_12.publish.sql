...
GO
PRINT N'Altering [dbo].[tbl_TinhHinhThuViec]...';


GO
ALTER TABLE [dbo].[tbl_TinhHinhThuViec] ALTER COLUMN [HieuQuaLamViec] NVARCHAR (MAX) NULL;

ALTER TABLE [dbo].[tbl_TinhHinhThuViec] ALTER COLUMN [KhaNangLamViec] NVARCHAR (MAX) NULL;

ALTER TABLE [dbo].[tbl_TinhHinhThuViec] ALTER COLUMN [KinhNghiemLamViec] NVARCHAR (MAX) NULL;

ALTER TABLE [dbo].[tbl_TinhHinhThuViec] ALTER COLUMN [NgayChapNhan] NVARCHAR (MAX) NULL;

ALTER TABLE [dbo].[tbl_TinhHinhThuViec] ALTER COLUMN [ThaiDoLamViec] NVARCHAR (MAX) NULL;
