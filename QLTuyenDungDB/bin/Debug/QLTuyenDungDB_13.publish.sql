...
GO
PRINT N'The following operation was generated from a refactoring log file f121d8c8-d139-4825-8f26-a9508cb7935f';

PRINT N'Rename [dbo].[tbl_NhanVien].[BacLuongID] to LuongYeuCau';


GO
EXECUTE sp_rename @objname = N'[dbo].[tbl_NhanVien].[BacLuongID]', @newname = N'LuongYeuCau', @objtype = N'COLUMN';


GO
PRINT N'Altering [dbo].[tbl_NhanVien]...';


GO
ALTER TABLE [dbo].[tbl_NhanVien] ALTER COLUMN [LuongYeuCau] NVARCHAR (50) NULL;


GO
-- Refactoring step to update target server with deployed transaction logs
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'f121d8c8-d139-4825-8f26-a9508cb7935f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('f121d8c8-d139-4825-8f26-a9508cb7935f')
