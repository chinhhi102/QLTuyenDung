...
GO
/*
The type for column ChuyenMonID in table [dbo].[tbl_TrinhDoHocVan] is currently  NVARCHAR (250) NULL but is being changed to  INT NULL. Data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[tbl_TrinhDoHocVan])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'The following operation was generated from a refactoring log file 41805a93-9403-4130-944c-033e38402f7d, 09ce0b2d-9a46-49a8-a11f-2eba0d757e0e';

PRINT N'Rename [dbo].[tbl_TrinhDoHocVan].[ChuyenNganh] to ChuyenMonID';


GO
EXECUTE sp_rename @objname = N'[dbo].[tbl_TrinhDoHocVan].[ChuyenNganh]', @newname = N'ChuyenMonID', @objtype = N'COLUMN';


GO
PRINT N'Altering [dbo].[tbl_TrinhDoHocVan]...';


GO
ALTER TABLE [dbo].[tbl_TrinhDoHocVan] ALTER COLUMN [ChuyenMonID] INT NULL;
